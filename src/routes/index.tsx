            ...
            <div className="mt-8 flex gap-3">
              {["FB", "IG", "IN", "YT"].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-[11px] text-white/70 transition-colors hover:border-white hover:text-white"
                >
                  {s}
                </a>
              ))}
