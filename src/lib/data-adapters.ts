...
export function propertyFromDoc(doc: PropertyDoc): Property {
  ...
  return {
    ...
    cardImage: doc.cardImage?.url ? resolveImage(doc.cardImage, 800) : (images[0] || "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=800&q=80"),
